var breakpoints = function() {
    ...
    var t = {
        ...
        // Überprüfung, ob ein bestimmter Breakpoint aktiv ist
        active: function(e) {
            var n, a, s, i, r, d, c;
            if (!(e in t.media)) {
        ...
        // Hinzufügen eines Ereignisses und sofortige Überprüfung der Bedingungen
        on: function(e, n) {
            t.events.push({
                query: e,
                handler: n,
        ...
        // Überprüfung aller Ereignisse bei bestimmten Events
        poll: function() {
            var e, n;
    ...
    // Rückgabe der öffentlichen Schnittstelle des Moduls
